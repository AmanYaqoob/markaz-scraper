...
export default function CategoryGrid({ categories }: { categories: Category[] }) {
  return (
    <section className="py-20 px-4 max-w-7xl mx-auto">
      <div className="mb-12 flex items-end justify-between animate-fade-up">
        <div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3">
        {categories.map((cat, i) => (
          <Link
            ...
            className="group block border border-[#1a1a1a] bg-[#0d0d0d] hover:border-white/20 hover:bg-[#111] transition-all duration-200 p-5 animate-fade-up"
